...
const MONGO_URI: string = `${env.database.MONGODB_URI}${env.database.MONGODB_DB_MAIN}`;

export const db: mongoose.Connection = createConnection(MONGO_URI, connectOptions);
